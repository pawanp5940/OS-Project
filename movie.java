...
public class movie
{
	...
	public static void read() throws IOException
	{
		...
		BufferedReader br = new BufferedReader(new FileReader("pawan.txt"));
		codes = br.readLine();
		br.close();
		...
		waitmutex();
		System.out.println("MUTEX:"+mutex);
		BufferedReader bre = new BufferedReader(new FileReader("pawan.txt"));
		codes = bre.readLine();
		bre.close();
		readers = codes.charAt(2)-'0';
		readers--;
		codes = codes.substring(0,2)+Integer.toString(readers);
		FileOutputStream fose = new FileOutputStream("pawan.txt");
